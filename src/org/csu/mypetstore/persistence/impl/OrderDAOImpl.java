...
public class OrderDAOImpl implements OrderDAO {
    ...
    public void insertOrder(Order order) {
        try {
            ...
            preparedStatement.setString(3, dateFormat.format(order.getOrderDate()));
